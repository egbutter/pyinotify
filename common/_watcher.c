...
/* this is the python method table <- makes C module callable */
/* TODO add multiple watchers on same thread */
static PyMethodDef watcher_object_methods[] = {
    {"watcher_start", (PyCFunction)watcher_start_function, METH_NOARGS, watcher_start_doc},
    {"watcher_stop", (PyCFunction)watcher_stop_function, METH_NOARGS, watcher_stop_doc},
    {NULL, NULL}
};
